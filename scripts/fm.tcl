...
set_app_var search_path "$search_path . ./rtl ./libs/DBs ./my_run"
...
save_session -replace ./my_run/pre_verify_${module_name}${n-bits}bits_${library}.fss 
...
save_session -replace ./my_run/post_verify_${module_name}${n-bits}bits_${library}.fss 
